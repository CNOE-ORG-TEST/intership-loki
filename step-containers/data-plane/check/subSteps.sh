...
function checkCFMandatoryParameters() {
  ...
  GIAS_ID_TAG_PARAMETER_CHECK="$(echo "${DATAPANEL_CLOUDFORMATION}" | jq -r '.Stacks[].Parameters[] | select(.ParameterKey=="GiasIDTagParameter") | .ParameterValue')"
  GIAS_NAME_TAG_PARAMETER_CHECK="$(echo "${DATAPANEL_CLOUDFORMATION}" | jq -r '.Stacks[].Parameters[] | select(.ParameterKey=="GiasNameTagParameter") | .ParameterValue')"
  ...
  #PROJECT_TAG_PARAMETER_CHECK="$(echo "${DATAPANEL_CLOUDFORMATION}" | jq -r '.Stacks[].Parameters[] | select(.ParameterKey=="ProjectTagParameter") | .ParameterValue')"
  ROLE_TAG_PARAMETER_CHECK="$(echo "${DATAPANEL_CLOUDFORMATION}" | jq -r '.Stacks[].Parameters[] | select(.ParameterKey=="RoleTagParameter") | .ParameterValue')"
  RUNNING_TAG_PARAMETER_CHECK="$(echo "${DATAPANEL_CLOUDFORMATION}" | jq -r '.Stacks[].Parameters[] | select(.ParameterKey=="RunningTagParameter") | .ParameterValue')"
